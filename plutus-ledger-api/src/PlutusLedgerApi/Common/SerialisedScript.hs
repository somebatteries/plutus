...
-}
assertScriptWellFormed :: forall m. MonadError ScriptDecodeError m
                       => LedgerPlutusVersion
                       -> ProtocolVersion
                       -> SerialisedScript
                       -> m ()
