...
instance (ToBuiltinMeaning uni fun1, ToBuiltinMeaning uni fun2) =>
    ...
    data BuiltinVersion (Either fun1 fun2) = EitherV (BuiltinVersion fun1) (BuiltinVersion fun2)

    toBuiltinMeaning (EitherV verL _) (Left  fun) = case toBuiltinMeaning verL fun of
    ...
    toBuiltinMeaning (EitherV _ verR) (Right fun) = case toBuiltinMeaning verR fun of
        BuiltinMeaning tySch toF (BuiltinRuntimeOptions runSch immF defF toExF) ->
...
defBuiltinsRuntimeExt = toBuiltinsRuntime (EitherV currentVerDefaultFun ExtensionFunV1) defaultUnliftingMode (defaultBuiltinCostModel, ())
...
instance uni ~ DefaultUni => ToBuiltinMeaning uni ExtensionFun where
    ...
    toBuiltinMeaning :: forall val. HasMeaningIn uni val => BuiltinVersion ExtensionFun -> ExtensionFun -> BuiltinMeaning val ()
    ...
    toBuiltinMeaning ver ExtensionVersion =
        ...
        (\(_ :: ()) -> case ver of
                ExtensionFunV0 -> EvaluationSuccess 0
                ExtensionFunV1 -> EvaluationSuccess 1
        )
        mempty  -- Whatever
