...
eraseTerm (LamAbs ann vars body) = UPLC.LamAbs ann (fmap fst vars) (eraseTerm body)
eraseTerm (Apply ann fun args)   = UPLC.Apply ann (eraseTerm fun) (fmap eraseTerm args)
