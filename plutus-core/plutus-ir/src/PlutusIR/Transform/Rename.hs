...
renameConstrTypeM
    :: (PLC.MonadRename m tyname, PLC.MonadQuote m)
...
renameConstrCM
    :: (PLC.MonadRename m tyname, PLC.MonadRename m name, PLC.MonadQuote m)
    => Restorer m
...
renameDatatypeCM
    :: (PLC.MonadRename m tyname, PLC.MonadRename m name, PLC.MonadQuote m, MonadReader ren m)
    => Recursivity
